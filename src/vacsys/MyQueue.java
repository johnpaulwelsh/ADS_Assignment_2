...
public class MyQueue<T> {
	...
	/**
	 * Method to add a Patient object to the beginning of the queue.
	 * Also sets the priorityVal for the queue, since we want to be
	 * able to compare queues even if they have been emptied of all
	 * their Patients.
	 * @param item the Patient being added
	 */
